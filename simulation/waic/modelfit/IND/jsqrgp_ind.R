...
for (datanum in 401:500){
  ...
  jsqr.fit <- qrjointgp2(x, y, par = 'prior', distance = distance, decaypar = c(0, max(distance)), nphi = 10, kernel = "matern", acpt.hptarget = 0.15, acpt.target = 0.15,  kappa = 2, nsamp = 2e3, thin = 10, fbase = 't')
